...
uint64 _mm_cvt_roundsd_u64 (__m128d a, int rounding);
...
uint64 _mm_cvt_roundss_u64 (__m128 a, int rounding);
__m128 _mm_cvt_roundu32_ss (__m128 a, unsigned int b, int rounding);
__m128d _mm_cvt_roundu64_sd (__m128d a, uint64 b, int rounding);
__m128 _mm_cvt_roundu64_ss (__m128 a, uint64 b, int rounding);
...
uint64 _mm_cvtsd_u64 (__m128d a);
...
uint64 _mm_cvtt_roundsd_u64 (__m128d a, int rounding);
...
uint64 _mm_cvtt_roundss_u64 (__m128 a, int rounding);
...
void _mm512_i32extscatter_ps (void * mv, __m512i index, __m512 v1, _MM_DOWNCONV_PS_ENUM conv, int scale, int hint);
...
uint64 _mm512_mask_reduce_max_epu64 (__mmask8 k, __m512i a);
uint64 _mm512_reduce_max_epu64 (__m512i a);
...
uint64 _mm512_mask_reduce_min_epu64 (__mmask8 k, __m512i a);
uint64 _mm512_reduce_min_epu64 (__m512i a);
